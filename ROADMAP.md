...
- [ ] Hierarchical & Non-Linear Systems
  - Hierarchical Systems
    ...
    4.  XML/HTML DOM Trees

    5.  JSON/Data Hierarchies
  ...
  - Non-Linear Systems
    ...
    5.  Adjacency Matrix/List

    6.  Knowledge Graphs

    7.  Knowledge Graphs

    8.  Spatial Partitioning Structures
        - Quadtree/Octree
...
- [ ] Concurrency & Real-World Constraints
  - Concurency Constrains
    ...
    3.  Concurrency Control in Databases
...
- [ ] Probabilistic & Approximation Algorithms
  - Probabilistic Algorithms
    ...
    3.  Atlantic City Algorithms (M.C. & L.V. Hybrid Algos)
...
- [ ] Geometry & Spatial Systems
  ...
  - Spatial Indexing & Accelertion Structures
    ...
    2.  Quadtrees/Octrees (covered above)

    3.  KD-Tree

    4.  BSP (Binary Space Partitioning) Tree

    5.  Grid spatial Partitioning

    6.  Bounding Volume Hierarchies (BVH)
...
- [ ] Quantum Computing Foundations
  ...
  - Hybrid Quantum-Classical Models
    1.  VQAs (Variational Quantum Algorithms)

    2.  Quantum ML Overview
